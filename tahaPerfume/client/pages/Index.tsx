...
import { Instagram, MessageCircle, Sparkles, Heart, Star } from "lucide-react";
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="animate-fade-in">
            <h1
              className={`text-5xl md:text-7xl lg:text-8xl font-bold mb-6 text-luxury-white ${isRTL ? "font-arabic" : "font-english"} text-shadow`}
            >
              {t("hero.title")}
            </h1>
            <h2
              ...
              >
                <div className="relative aspect-square overflow-hidden">
                  ...
                  <div className="absolute top-4 right-4">
                    <div className="bg-luxury-gold text-luxury-white p-2 rounded-full">
                      <Star size={16} />
                    </div>
                  </div>
                </div>
                <div className="p-6">
                  ...
                  <p
                    className={`text-luxury-black/70 mb-4 ${isRTL ? "font-arabic" : "font-sans"}`}
                  >
